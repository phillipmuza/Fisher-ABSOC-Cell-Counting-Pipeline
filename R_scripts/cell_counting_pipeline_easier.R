...
decoded_atlas_file = "R:/resources/ccfv3_functional.csv" #The PATH to your atlas file 
cell_counter = "R:/resources/cell_count_analysis/functional_analysis/cell_counter_config_easier.R" # The PATH to the cell counter script 

#Enter the path to your directory with the folders with your slice data
parent.folder <- "R:/dp9tyb_NPY_HC/rep reg with npy image"
